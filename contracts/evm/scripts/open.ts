...
import { formatUnits, JsonRpcProvider, parseUnits, Wallet, ZeroAddress } from 'ethers';
...
async function main() {
  ...
  program
    ...
    .option('--fill-expire <fill-expire>', 'The fill expire time in seconds', '86400')
    ...
    .action(async cmd => {
      ...
      console.log(`Order data: ${JSON.stringify(orderData, (_, value) =>
